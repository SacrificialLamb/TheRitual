...
public class blockdropper : uScriptLogic
{
   ...
   System.Object[] logic_uScriptAct_Log_Target_9 = new System.Object[] {"YOU ARE A WINRAR!"};
   System.Object logic_uScriptAct_Log_Postfix_9 = "";
   bool logic_uScriptAct_Log_Out_9 = true;
   //pointer to script instanced logic node
   uScriptAct_Destroy logic_uScriptAct_Destroy_uScriptAct_Destroy_13 = new uScriptAct_Destroy( );
   UnityEngine.GameObject[] logic_uScriptAct_Destroy_Target_13 = new UnityEngine.GameObject[] {};
   System.Single logic_uScriptAct_Destroy_DelayTime_13 = (float) 0;
   bool logic_uScriptAct_Destroy_Out_13 = true;
   bool logic_uScriptAct_Destroy_ObjectsDestroyed_13 = true;
   bool logic_uScriptAct_Destroy_WaitOneTick_13 = false;
   //pointer to script instanced logic node
   uScriptAct_SetInt logic_uScriptAct_SetInt_uScriptAct_SetInt_14 = new uScriptAct_SetInt( );
   ...
   void SyncUnityHooks( )
   {
      ...
      {
         local_10_UnityEngine_GameObject = GameObject.Find( "/BlockDropperPlane" ) as UnityEngine.GameObject;
      }
      //if our game object reference was changed then we need to reset event listeners
      if ( local_10_UnityEngine_GameObject_previous != local_10_UnityEngine_GameObject || false == m_RegisteredForEvents )
      {
         ...
         {
            {
               uScript_Trigger component = local_10_UnityEngine_GameObject_previous.GetComponent<uScript_Trigger>();
               if ( null != component )
               {
         ...
         {
            {
               uScript_Trigger component = local_10_UnityEngine_GameObject.GetComponent<uScript_Trigger>();
               if ( null == component )
               {
                  component = local_10_UnityEngine_GameObject.AddComponent<uScript_Trigger>();
               }
               if ( null != component )
               {
                  component.OnEnterTrigger += Instance_OnEnterTrigger_0;
      ...
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("42030b77-57d4-42b9-8be1-10d31a2e931b", "GameObject_Has_Tag", Relay_In_1)) return; 
         {
            ...
            }
            {
               ...
               logic_uScriptCon_GameObjectHasTag_Tag_1[ index++ ] = local_11_System_String;
   ...
   void Relay_In_9()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("0b0d34fc-9116-4714-867c-aa3ea2aaed3a", "Log", Relay_In_9)) return; 
         {
            {
            }
            {
      ...
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript blockdropper.uscript at Log.  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
      }
   }
   ...
   void Relay_In_13()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("0aaad8d7-ceb0-4ff5-8eb0-d133633b1c33", "Destroy", Relay_In_13)) return; 
         {
            {
               int index = 0;
               {
               ...
               if ( logic_uScriptAct_Destroy_Target_13.Length <= index)
               {
                  System.Array.Resize(ref logic_uScriptAct_Destroy_Target_13, index + 1);
               }
               logic_uScriptAct_Destroy_Target_13[ index++ ] = local_2_UnityEngine_GameObject;
               
            }
            {
            }
         }
         logic_uScriptAct_Destroy_uScriptAct_Destroy_13.In(logic_uScriptAct_Destroy_Target_13, logic_uScriptAct_Destroy_DelayTime_13);
         logic_uScriptAct_Destroy_WaitOneTick_13 = true;
   ...
   void Relay_WaitOneTick_13( )
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         ...
         logic_uScriptAct_Destroy_WaitOneTick_13 = logic_uScriptAct_Destroy_uScriptAct_Destroy_13.WaitOneTick();
         if ( true == logic_uScriptAct_Destroy_WaitOneTick_13 )
         {
         }
      }
   ...
   void Relay_In_14()
   {
      if ( relayCallCount++ < MaxRelayCallCount )
      {
         if (true == CheckDebugBreak("56015b9d-5255-4ba1-80d7-4514d92ec2e3", "Set_Int", Relay_In_14)) return; 
         {
            {
            }
            {
         ...
         amount2 = logic_uScriptAct_SetInt_Target_14;
   ...
   private void UpdateEditorValues( )
   {
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "e2045d3e-196d-4203-90ee-2f6ee18b847b", local_10_UnityEngine_GameObject);
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "blockdropper.uscript:11", local_11_System_String);
