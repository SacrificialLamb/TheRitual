...
public class testi : uScriptLogic
{
   ...
   void Relay_Finished_0()
   {
      ...
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript testi.uscript at Move To Location.  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
      }
   }
   ...
   void Relay_In_2()
   {
      ...
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript testi.uscript at Log.  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
      }
   }
   ...
   void Relay_In_16()
   {
      ...
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript testi.uscript at Set Vector3.  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
      }
   }
   ...
   void Relay_In_19()
   {
      ...
      {
         uScriptDebug.Log( "Possible infinite loop detected in uScript testi.uscript at Get Parent.  If this is in error you can change the Maximum Node Recursion in the Preferences Panel and regenerate the script.", uScriptDebug.Type.Error);
      }
   }
   ...
   {
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "testi.uscript:Cube1", local_Cube1_UnityEngine_GameObject);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "testi.uscript:11", local_11_UnityEngine_Vector3);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "testi.uscript:12", local_12_UnityEngine_Vector3);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "testi.uscript:13", local_13_UnityEngine_GameObject);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "testi.uscript:18", local_18_UnityEngine_Vector3);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "testi.uscript:20", local_20_UnityEngine_GameObject);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "testi.uscript:Cube2", local_Cube2_UnityEngine_GameObject);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "testi.uscript:25", local_25_UnityEngine_Vector3);
      ...
      uScript_MasterComponent.LatestMasterComponent.UpdateNodeValue( "testi.uscript:29", local_29_UnityEngine_Vector3);
